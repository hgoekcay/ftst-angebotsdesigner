...
def register(app, base, ingress, escape, get_store):
    ...
    def quote_draft(key):
        ...
        if request.args.get('customer_selected') and draft.get('client_id'):
            saved += '<p class="success">Kunde im Entwurf ausgewählt. Aktuelle Preise und Steuerregel bitte erneut prüfen und speichern.</p>'

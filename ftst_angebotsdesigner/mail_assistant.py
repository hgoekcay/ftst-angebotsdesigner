...
def register(app, base, ingress, escape, get_store):
    ...
    def mail_list():
        ...
        return base('Mail-Arbeitsliste', '<div class="card"><h1>Mail-Arbeitsliste & Antwortassistent</h1><p>Kundenanfrage einfügen, lokal prüfen und einen Antwortentwurf bearbeiten. Kein Postfachzugriff und kein Versand.</p>' + filters + '</div>' + rows + upload + '<div class="card"><h2>Anfrage als Text aufnehmen</h2>'

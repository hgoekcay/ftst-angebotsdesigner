...
def edit(oid):
    ...
    if request.method=="POST":
        src={k:request.form.get(k,"") for k in ("offer_type","customer_title","customer_intro","project_summary","benefits","next_steps")};session["ftst_"+oid]=src;session.modified=True

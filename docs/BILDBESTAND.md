...
Unter „Fotos auswählen“ stehen acht Motive mit Vorschauen bereit. Die Auswahl wird pro Billomat-Konto und Angebot gespeichert. Keine automatische Ergänzung von Fotoseiten zu bestehenden Angeboten. Höchstens acht Bilder, nach Kategorie gruppiert, bis zu vier Bilder pro PDF-Seite. Firmenlogos werden in dieser Fotoauswahl ausgeblendet; Logoauswahl unter Firmendaten. Eigene Uploads bleiben im persistenten Datenverzeichnis.
...
58 Tests einschließlich Erkennung, Speicherung, Angebotsentwurf, Bilddateien, Kontentrennung, Logoabschaltung, Ingress-Links, fehlender Dateien und PDF-Bildern. Sechsseitiges Musterangebot lokal gerendert und visuell geprüft.

## Noch in Home Assistant prüfen

Nach Backup und Installation: Add-on-Version 0.3.1, bestehende Firmendaten/Projekte, alle Bildvorschauen über Ingress, Bildauswahl nach Neustart, PDF im separaten Tab, Live-Billomat-Katalog und Kundenpreisgruppen. Diese neue Fassung wurde noch nicht in HA installiert.

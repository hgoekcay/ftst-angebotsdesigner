...
Home-Assistant-App mit Billomat als Datenquelle. Aktueller Entwicklungsstand: **0.19.0**.

## Funktionen

Billomat-Angebote anzeigen, Angebotstyp erkennen, Kundendarstellung dauerhaft bearbeiten und als A4-PDF speichern. Firmendaten, Logo und bis zu vier Referenzbilder auf einer Seite ergänzen. Projekte mit Technikeraufnahme, Ajax-Schnellauswahl, lokaler KI, Billomat-Kalkulation und ausdrücklich bestätigter Entwurfsübergabe vorbereiten. Lager und Materialplanung unterstützen die weitere Bearbeitung.
...
- [Technikeraufnahme und Projektablauf](docs/TECHNIKERAUFNAHME.md)
